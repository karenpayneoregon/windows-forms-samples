...
public class Dialogs
{
    ...
    /// <param name="defaultButton">Button to focus</param>
    /// <returns>true for yes button, false for no button</returns>
    public static (bool yesNo, bool verify) Question(Control owner, string heading, DialogResult defaultButton = DialogResult.Yes)
    {
        ...
        var result = TaskDialog.ShowDialog(owner, page);
        return (result.Tag is not null && (DialogResult)result.Tag == DialogResult.Yes, checkBox.Checked);
    }
    ...
    public static void ShowEventsTaskDialog()
    {
        ...
        {
            Caption = "Text",
            Heading = "Event Demo - see Visual Studio output window for more",
            Text = "Event Demo...",
        };
